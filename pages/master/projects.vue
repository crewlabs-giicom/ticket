<template>
  <div class="max-w-2xl space-y-4">
    <div class="flex items-center justify-between">
      <p class="text-sm text-slate-500">Kelola project untuk pengelompokan tiket</p>
      <button @click="openForm()" class="btn-primary">+ Tambah Project</button>
    </div>

    <div class="card overflow-hidden">
      <div class="divide-y divide-slate-100">
        <div v-for="p in projects" :key="p.id" class="flex items-center gap-3 px-4 py-3 hover:bg-slate-50">
